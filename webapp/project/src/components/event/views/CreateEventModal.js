...
class CreateEventModal extends Component {
    ...
    componentWillMount() {
        const {startTimeSelected, endTimeSelected} = this.props;
        this.setState({
            start: startTimeSelected ? startTimeSelected : new Date(),
            end: endTimeSelected ? endTimeSelected : new Date(),
        })
    }

    componentWillReceiveProps(nextProps) {
        if (nextProps.startTimeSelected !== this.props.startTimeSelected ||
            nextProps.endTimeSelected !== this.props.endTimeSelected) {
            const {startTimeSelected, endTimeSelected} = nextProps;
            this.setState({
                start: startTimeSelected ? startTimeSelected : new Date(),
                end: endTimeSelected ? endTimeSelected : new Date(),
            })
    ...
    render() {
        ...
        return (
            <Modal open={modalIsOpen}
                ...
                <h2 className="title-modal">{renderModalTitle(classDetail)}</h2>
                <form className="create-event-modal form-horizontal" role="form">
                    <div className="event-content-input clearfix">
                        <label className="col-sm-3 control-label hidden-xs">Event Photo</label>
                                ...
                                !uploadedPhoto ?
                                    ...
                                    (
                                        <div className="event-photo-preview">
                                            ...
                                            <button className="remove-upload-event-photo"
                    ...
                    <div className="event-content-input clearfix">
                        <label className="col-sm-3 control-label hidden-xs">Title</label>
                        <div className="col-sm-9">
                    ...
                    <div className="event-content-input clearfix">
                        <label className="col-sm-3 control-label hidden-xs">Location</label>
                        <div className="col-sm-9">
                    ...
                    <div className="event-content-input clearfix">
                        <label className="col-sm-3 control-label hidden-xs">Frequency</label>
                        <div className="col-sm-9">
                        ...
                        <div className="col-sm-9 col-sm-offset-3">
                            {
                                ...
                                <div className="frequency-once">
                                    <div className="form-group">
                                        ...
                                        <div className='event-end-date col-sm-4'>
                                            <Datetime inputProps={{readOnly: true}} timeFormat={false}
                                                      inputFormat="DD/MM/YYYY" value={start}
                                                      onChange={this.handleChangeStartTime}/>
                                        </div>
                                        {
                                            !startAllDay &&
                                            (
                                                <div className='event-end-time col-sm-4'>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <div className='event-end-date col-sm-4'>
                                            <Datetime inputProps={{readOnly: true}} timeFormat={false}
                                                      inputFormat="DD/MM/YYYY" value={end}
                    ...
                    <div className="event-content-input clearfix">
                        <label className="col-sm-3 control-label hidden-xs">Description</label>
                        <div className="col-sm-9">
